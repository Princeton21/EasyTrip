      ...
      <div className="about_us">
        <div className="story">
          ...
          <p>
            ...
            vero dolor quo esse voluptatibus non officia inventore.lorem Lorem ipsum dolor sit amet. Ab vero dolor quo esse
            voluptatibus non officia inventore Lorem ipsum dolor sit amet. Ab
            vero dolor quo esse voluptatilorem Lorem ipsum dolor sit amet. Ab vero dolor quo esse
            voluptatibus non officia inventore Lorem ipsum dolor sit amet. Ab
        ...
        <div className="team">
          ...
          <div className="card">      
            <div className="bg">
            <img src={bhushan} className="card_img" />
              ...
              <div className="socials">
                <img className="github_icon" src={linkedin}></img>
                <img className="linkedin_icon" src={github}></img>
              </div>
              </div>
            </div>
          </div>
